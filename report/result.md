...
![Кол-во итераций градиентного спуска в замисимости от $\lambda$](../figs/task7/iter_gd.png)

Кол-во итераций метода Ньютона в замисимости от $\lambda$

![Кол-во итераций метода Ньютона в замисимости от $\lambda$](../figs/task7/iter_new.png)

Время работы градиентного спуска в замисимости от $\lambda$

![Время работы градиентного спуска в замисимости от $\lambda$](../figs/task7/time_gd.png)

Время работы метода Ньютона в замисимости от $\lambda$

![Время работы метода Ньютона в замисимости от $\lambda$](../figs/task7/time_new.png)

Норма отимальной точки в градиентном спуске в замисимости от $\lambda$

![Норма отимальной точки в градиентном спуске в замисимости от $\lambda$](../figs/task7/mean_gd.png)

Норма отимальной точки в методе Ньютона в замисимости от $\lambda$

![Норма отимальной точки в методе Ньютона в замисимости от $\lambda$](../figs/task7/mean_new.png)
